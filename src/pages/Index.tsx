  ...
  <section className="relative min-h-screen flex items-center pt-20 px-6 md:px-10 bg-gradient-to-b from-white to-gray-50">
    <div className="max-w-7xl mx-auto w-full">
      <div className="flex flex-col items-center text-center">
        ...
        <div className="relative w-full h-64 md:h-80 lg:h-96 mb-8 animate-fade-up" style={{ animationDelay: '0.1s' }}>
          <img
        ...
        <div className="max-w-2xl mx-auto text-gray-600 text-lg md:text-xl mb-8 animate-fade-up" style={{ animationDelay: '0.2s' }}>
          <p className="mb-4">Join the agricultural revolution with AgriHub and discover the benefits of smart farming solutions.</p>
          <p className="mb-4">Connect with fellow farmers and agricultural experts to maximize your productivity and profit.</p>
          <p className="mb-4">Our AI-driven platform ensures that you receive the right resources at the right time, every time.</p>
        </div>
